...
import { ArrowLeft, Calendar, Phone, ShieldAlert, Activity, Search, Heart, Scissors, Sparkles, Stethoscope, AlertTriangle, Bone, ShieldCheck } from "lucide-react";

const ComplexDentalExtractions = () => {
  ...
  const necessaryReasons = [
    {
      ...
      desc: "Teeth that are partially or fully impacted, such as impacted wisdom teeth, may require surgical extraction to access and remove them.",
      icon: <ShieldAlert className="w-6 h-6" />
    },
    {
      title: "Severely Damaged Teeth",
      desc: "Teeth that are severely decayed, broken, or fractured might require surgical extraction, especially if they cannot be saved through other treatments.",
      icon: <AlertTriangle className="w-6 h-6" />
    },
    {
      title: "Anatomical Variations",
      desc: "Unusual tooth root shapes or positions, such as curved roots, can make extraction more challenging.",
  ...
  const processSteps = [
    {
      ...
      desc: "We conduct a thorough evaluation, including X-rays, to assess the complexity of the extraction and plan accordingly.",
      icon: <Search className="w-6 h-6" />
    },
    {
      title: "Anesthesia",
      desc: "Local anesthesia is administered to ensure your comfort during the procedure.",
      icon: <Heart className="w-6 h-6" />
    },
    {
      title: "Surgical Techniques",
      desc: "For impacted teeth or challenging cases, surgical techniques may be employed to access and remove the tooth safely.",
      icon: <Scissors className="w-6 h-6" />
    },
    {
      title: "Preserving Surrounding Structures",
      desc: "Our skilled team takes utmost care to protect surrounding structures like nerves and sinuses during the extraction.",
      icon: <ShieldCheck className="w-6 h-6" />
    },
    {
      title: "Stitches and Aftercare",
      desc: "Depending on the case, stitches may be used to aid in healing. We provide post-operative instructions to ensure proper recovery.",
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20 mb-20">
          <div className="lg:w-1/2 text-center lg:text-left">
            ...
            >
              Complex Dental <span className="text-transparent bg-clip-text bg-gradient-to-r from-lightblue to-blue-400">Extractions</span>
            </motion.h1>
            <motion.p 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              We are committed to providing comprehensive dental care, including complex dental extractions, to ensure your oral health and well-being. Our experienced team is equipped to handle even the most challenging cases with precision and care.
            </motion.p>
          </div>
          ...
          >
            <div className="relative rounded-[2rem] overflow-hidden shadow-2xl aspect-[4/3] group border border-gray-100 dark:border-white/10">
              <img 
                ...
                alt="Complex Dental Extractions" 
        ...
        {/* Section 1: Understanding / When Necessary */}
        <motion.div 
        ...
        >
          <div className="mb-10 text-center md:text-left">
            <h2 className="text-3xl font-bold text-myblack dark:text-lightbg mb-4 transition-colors">Understanding Complex Dental Extractions</h2>
            <p className="text-mydark dark:text-lightbg/70 max-w-3xl font-light text-lg transition-colors">
              Complex dental extractions involve the removal of teeth that present unique challenges due to factors such as impaction, root curvature, or proximity to vital structures like nerves and sinuses. These situations may require specialized techniques and expertise to ensure a safe and successful procedure.
            </p>
          </div>
        ...
        >
          <div className="mb-10 text-center md:text-left">
            <h2 className="text-3xl font-bold text-myblack dark:text-lightbg mb-4 transition-colors">The Complex Extraction Process</h2>
            <p className="text-mydark dark:text-lightbg/70 max-w-2xl font-light text-lg transition-colors">
              At Highland Hills Dental Centre, we follow a meticulous process to ensure the success of complex dental extractions.
            </p>
          </div>
        ...
        >
          <h2 className="text-2xl md:text-3xl font-bold text-myblack dark:text-lightbg mb-4 transition-colors">Committed to Your Comfort and Well-Being</h2>
          <p className="text-mydark dark:text-lightbg/80 mb-4 max-w-2xl mx-auto font-light leading-relaxed transition-colors">
            We understand that complex dental extractions can be concerning, but rest assured that our experienced team is dedicated to providing you with a comfortable experience. We take the time to explain the procedure, address your questions, and ensure you're well-informed throughout the process.
          </p>
          <p className="text-mydark dark:text-lightbg/80 mb-6 max-w-2xl mx-auto font-light leading-relaxed transition-colors">
            At Highland Hills Dental Centre, your oral health and safety are our top priorities. Whether you're facing a challenging extraction or need information about your treatment options, we're here to provide you with expert care and support.
          </p>
...
export default ComplexDentalExtractions;
