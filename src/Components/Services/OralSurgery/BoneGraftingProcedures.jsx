...
import { ArrowLeft, Calendar, Phone, Activity, Search, Sparkles, ShieldCheck, Bone, Stethoscope, Smile, Anchor } from "lucide-react";

const BoneGraftingProcedures = () => {
  ...
  const understandingGrafting = [
    {
      title: "Prepare for Dental Implants",
      desc: "Adequate bone volume and density are essential for successful dental implant placement. Bone grafting can augment areas with insufficient bone to support implants.",
      icon: <Anchor className="w-6 h-6" />
    },
    {
      title: "Restore Jawbone Structure",
      desc: "Bone loss can occur due to tooth extractions, gum disease, or trauma. Bone grafting can restore the jawbone's shape and density.",
      icon: <Bone className="w-6 h-6" />
    },
    {
      title: "Enhance Aesthetic Results",
      desc: "Bone grafting can improve the appearance of the jawline and facial contours, particularly in cases of significant bone loss.",
  ...
  const processSteps = [
    {
      title: "Evaluation",
      desc: "We assess your oral health, taking X-rays or 3D scans to determine the extent of bone loss and the best approach for grafting.",
      icon: <Search className="w-6 h-6" />
    },
    {
      title: "Graft Material",
      desc: "Depending on your needs, we use either your own bone, donor bone, synthetic bone material, or a combination.",
      icon: <Sparkles className="w-6 h-6" />
    },
    {
      title: "Graft Placement",
      desc: "The graft material is carefully placed in the targeted area, promoting new bone growth over time.",
      icon: <ShieldCheck className="w-6 h-6" />
    },
    {
      title: "Healing and Integration",
      desc: "Over the coming months, your body will naturally integrate the graft material with your existing bone, creating a strong foundation.",
      icon: <Activity className="w-6 h-6" />
    },
    {
      title: "Follow-up",
      desc: "We monitor your healing progress through follow-up appointments to ensure proper integration and successful outcomes.",
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20 mb-20">
          <div className="lg:w-1/2 text-center lg:text-left">
            ...
            >
              Bone Grafting <span className="text-transparent bg-clip-text bg-gradient-to-r from-lightblue to-blue-400">Procedures</span>
            </motion.h1>
            <motion.p 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              We offer advanced bone grafting procedures to provide a solid foundation for various dental treatments. Our skilled team is committed to ensuring your oral health and enabling successful outcomes for your dental procedures.
            </motion.p>
          </div>
        ...
        >
          <div className="mb-10 text-center md:text-left">
            <h2 className="text-3xl font-bold text-myblack dark:text-lightbg mb-4 transition-colors">Understanding Bone Grafting</h2>
            <p className="text-mydark dark:text-lightbg/70 max-w-3xl font-light text-lg transition-colors">
              Bone grafting is a surgical procedure that involves adding bone or a bone substitute to areas where bone loss has occurred. This procedure is commonly used to:
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            {understandingGrafting.map((item, idx) => (
        ...
        >
          <div className="mb-10 text-center md:text-left">
            <h2 className="text-3xl font-bold text-myblack dark:text-lightbg mb-4 transition-colors">The Bone Grafting Process</h2>
            <p className="text-mydark dark:text-lightbg/70 max-w-2xl font-light text-lg transition-colors">
              At Highland Hills Dental Centre, we follow a comprehensive approach to bone grafting procedures:
            </p>
          </div>
        ...
        >
          <h2 className="text-2xl md:text-3xl font-bold text-myblack dark:text-lightbg mb-4 transition-colors">A Foundation for Dental Health</h2>
          <p className="text-mydark dark:text-lightbg/80 mb-4 max-w-2xl mx-auto font-light leading-relaxed transition-colors">
            Our experienced team is dedicated to providing expert care throughout the bone grafting process. We prioritize your comfort, well-being, and the success of your dental treatments.
          </p>
          <p className="text-mydark dark:text-lightbg/80 mb-6 max-w-2xl mx-auto font-light leading-relaxed transition-colors">
            Whether you're considering dental implants, addressing bone loss, or enhancing your facial aesthetics, bone grafting can provide a solid foundation for your dental health and overall well-being. If you're curious about bone grafting or have concerns about your bone structure, we encourage you to schedule a consultation. Our experts will assess your dental health, discuss your options, and create a personalized treatment plan that meets your needs.
          </p>
...
export default BoneGraftingProcedures;
