...
import { ArrowLeft, Calendar, Phone, Activity, HeartPulse, ShieldCheck, Heart, Syringe, Clock, CheckCircle } from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20 mb-20">
          <div className="lg:w-1/2 text-center lg:text-left">
            ...
            >
              General <span className="text-transparent bg-clip-text bg-gradient-to-r from-lightblue to-blue-400">Anesthesia</span>
            </motion.h1>
            <motion.p 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
